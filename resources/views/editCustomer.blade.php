                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('save_edit_customer') }}">
                                        @csrf
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="name" type="text"
                                                    ...
                                                    value="{{ $edit_customer_data['name'] }}" autofocus>
                                        ...
                                        <div class="row mb-3">
                                            <label for="countyr_code" class="col-md-4 col-form-label text-md-end">Country
                                                Code</label>
                                            ...
                                            <div class="col-md-6">
                                                <select name="countryCode"
                                                    ...
                                                    <optgroup label="Other countries">
                                                        ...
                                                        <option value="+1268-Antigua & Barbuda">Antigua &amp; Barbuda
                                                            (+1268)
                                                        </option>
                                                        ...
                                                        <option value="+236-Central African Republic">Central African
                                                            Republic
                                                            (+236)</option>
                                                        ...
                                                        <option value="+1868-Trinidad & Tobago">Trinidad &amp; Tobago
                                                            (+1868)
                                                        </option>
                                                        ...
                                                        <option value="+1649-Turks & Caicos Islands">Turks &amp; Caicos
                                                            Islands
                                                            (+1649)</option>
                                                        ...
                                                        <option value="+971-United Arab Emirates">United Arab Emirates
                                                            (+971)
                                                        </option>
                                                        ...
                                                        <option value="+84-Virgin Islands - British">Virgin Islands -
                                                            British
                                                            (+1284)</option>
                                        ...
                                        <div class="row mb-3">
                                            <label for="mobile"
                                                class="col-md-4 col-form-label text-md-end">Mobile {{ $edit_customer_data['country_code']}}</label>

                                            <div class="col-md-6">
                                                <input id="mobile" type="number"
                                                    class="form-control @error('mobile') is-invalid @enderror"
                                                    name="mobile" value="{{ $edit_customer_data['mobile'] }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <Select id="status"
                                                    ...
                                                    name="status">
                                                    <option value="Active" {{ $edit_customer_data->status == "Active"? 'selected' : '' }}>Active</option>
                                                    <option value="In-Active" {{ $edit_customer_data->status == "In-Active" ? 'selected' : '' }}>In-Active</option>
                                                </Select>
                                        ...
                                        <input type="hidden" name="customer_id" value={{ $edit_customer_data['id'] }}>
